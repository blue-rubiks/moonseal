...
const mocks = vi.hoisted(() => {
  ...
  return { startMock, loadedMock, FakeGain, FakePlayer, FakeNoise, playerInstances, noiseInstances };
});
...
const { playerInstances, noiseInstances, startMock, loadedMock } = mocks;
